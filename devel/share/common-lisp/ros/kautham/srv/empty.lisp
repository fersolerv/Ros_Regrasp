...
(cl:defmethod cl:initialize-instance :after ((m <empty-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'empty-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kautham-srv:<empty-request> is deprecated: use kautham-srv:empty-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <empty-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'empty-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kautham-srv:<empty-response> is deprecated: use kautham-srv:empty-response instead.")))
